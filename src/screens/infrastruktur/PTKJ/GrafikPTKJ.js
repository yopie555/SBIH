...
const GrafikPTKJ = (props) => {
  ...
  const getRoadConditionCategory = (kemantapan) => {
    ...
    if (value >= 80) return { label: 'Sangat Mantap', color: '#43a047' };
    if (value >= 60 && value < 80) return { label: 'Mantap', color: '#1e88e5' };
    if (value >= 40 && value < 60) return { label: 'Sedang', color: '#fb8c00' };
    return { label: 'Kurang Mantap', color: '#e53935' };
  };

  const currentCategory = getRoadConditionCategory(latestValue);
            ...
            <View style={styles.currentValueContainer}>
              ...
              <View style={styles.currentValueWrapper}>
                <Text style={styles.currentValueText}>
                  Kemantapan Terkini: <Text style={[styles.currentValue, { color: currentCategory.color }]}>{formatPercentage(latestValue)}%</Text>
                </Text>
            ...
            <View style={styles.trendContent}>
              ...
              <Text style={styles.trendDescription}>
                {latestValue > values[0] 
                  ? 'Tren meningkat, kualitas jalan semakin membaik' 
                  : 'Tren menurun, perlu pemeliharaan dan perbaikan jalan'}
              </Text>
            </View>
          </View>
        )}
        ...
        {latestValue < 100 && (
          <View style={styles.targetCard}>
            <View style={styles.targetHeader}>
              ...
              <Text style={styles.targetTitle}>Target Kemantapan Ideal</Text>
            </View>
            <View style={styles.targetContent}>
              ...
              <Text style={styles.targetText}>
                {formatPercentage(100 - latestValue)}% lagi untuk mencapai kondisi jalan ideal (100%)
              </Text>
            </View>
          </View>
        )}
        ...
        {last5Years.length > 0 && (
          <View style={styles.infoCard}>
            ...
            <View style={styles.infoContent}>
              ...
              <View style={styles.infoRow}>
                <View style={styles.infoDot} />
                <Text style={styles.infoText}>Persentase tingkat kemantapan jalan</Text>
              </View>
              <View style={styles.infoRow}>
                <View style={styles.infoDot} />
              ...
              <View style={styles.infoRow}>
                <View style={styles.infoDot} />
                <Text style={styles.infoText}>Semakin tinggi nilai, semakin baik kondisi jalan</Text>
              </View>
            </View>
          </View>
        )}
