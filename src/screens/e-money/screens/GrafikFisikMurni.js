...
const GrafikFisikMurni = () => {
    const { dataAnggaran } = stateDataAnggaran();
    const data = dataAnggaran?.chart_fisik_murni?.[0] || [];
    const data1 = dataAnggaran?.chart_fisik_murni?.[1] || [];
                ...
                <>
                    ...
                    <View style={styles.infoCard}>
                        <View style={styles.infoHeader}>
                            <Icon name="construct" size={24} color="#0074BD" />
                            <Text style={styles.infoTitle}>Grafik Fisik APBD Murni</Text>
                        </View>
                        <Text style={styles.infoText}>
                            Grafik perbandingan Target dan Realisasi Fisik APBD Murni per bulan
                        </Text>
                    </View>
                    ...
                    <View style={styles.legendCard}>
                        ...
                        <View style={styles.legendContent}>
                            <View style={styles.legendItem}>
                                ...
                                <Text style={styles.legendText}>Target Fisik</Text>
                            </View>
                            <View style={styles.legendItem}>
                                <View style={[styles.legendDot, { backgroundColor: 'rgba(251, 140, 0, 1)' }]} />
                                <Text style={styles.legendText}>Realisasi Fisik</Text>
                            </View>
                        </View>
                    </View>
...
export default GrafikFisikMurni;