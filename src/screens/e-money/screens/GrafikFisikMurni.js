...
const GrafikAnggaranFisik = () => {
    const {dataAnggaran} = stateDataAnggaran()
    const data = dataAnggaran?.chart_fisik_murni?.[0] || []; // Fallback to a default array  
    const data1 = dataAnggaran?.chart_fisik_murni?.[1] || []; // Fallback to a default array  
