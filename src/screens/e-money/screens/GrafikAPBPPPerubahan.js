...
const GrafikAPBPPPerubahan = () => {
    ...
    const data = dataAnggaran?.chart_keuangan_perubahan?.[0] || [];
    const data1 = dataAnggaran?.chart_keuangan_perubahan?.[1] || [];
                ...
                <>
                    ...
                    <View style={styles.infoCard}>
                        <View style={styles.infoHeader}>
                            ...
                            <Text style={styles.infoTitle}>Grafik Keuangan APBP Perubahan</Text>
                        </View>
                        <Text style={styles.infoText}>
                            Grafik perbandingan Target dan Realisasi Keuangan APBP Perubahan per bulan
                        </Text>
                    </View>
...
export default GrafikAPBPPPerubahan;