...
const GrafikFisikAPBPPPerubahan = () => {
    ...
    const data = dataAnggaran?.chart_fisik_perubahan?.[0] || [];
    const data1 = dataAnggaran?.chart_fisik_perubahan?.[1] || [];
                ...
                <>
                    ...
                    <View style={styles.infoCard}>
                        <View style={styles.infoHeader}>
                            ...
                            <Text style={styles.infoTitle}>Grafik Fisik APBP Perubahan</Text>
                        </View>
                        <Text style={styles.infoText}>
                            Grafik perbandingan Target dan Realisasi Fisik APBP Perubahan per bulan
                        </Text>
                    </View>
