...
const APBPPerubahan = () => {
  ...
  const data = dataAnggaran?.statistik1_perubahan; // Access params safely
  ...
  const paguDana = data?.PaguDana2;
  const formattedJumlahProgram1 = formatRupiah(paguDana);

  const realisasi = data?.RealisasiKeuangan2;
  const formattedRealisasi = formatRupiah(realisasi);

  return (
    <View style={styles.container}>
      <View style={styles.cards}>
        <Text style={{ color: 'gold', marginLeft: 25, fontSize: 16, marginVertical: 5 }}>APBD Perubahan</Text>
      ...
      <View style={styles.cards2}>
        ...
        <View style={styles.insideCard}>
          ...
          <View style={{ paddingLeft: 10 }}>
            ...
            <Text style={{ color: '#fff' }}>Program : {data?.JumlahProgram2}</Text>
            <Text style={{ color: '#fff' }}>Kegiatan : {data?.JumlahKegiatan2}</Text>
          </View>
        </View>
      </View>
      <View style={styles.cards3}>
        ...
        <View style={styles.insideCard}>
          ...
          <View style={{ paddingLeft: 10 }}>
            ...
            <Text style={{ color: '#fff' }}>({data?.PersenRealisasiKeuangan2}%)</Text>
          </View>
        </View>
      </View>
      <View style={styles.cards4}>
        ...
        <View style={styles.insideCard}>
          ...
          <View style={{ paddingLeft: 10 }}>
            ...
            <Text style={{ color: '#fff' }}>({data?.RealisasiFisik2}%)</Text>
          </View>
        </View>
      </View>
    </View>
