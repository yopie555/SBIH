...
const APBPPerubahan = () => {
  ...
  const data = dataAnggaran?.statistik1_perubahan;
  ...
  const persenRealisasiKeuangan = data?.PersenRealisasiKeuangan2 || 0;
  const realisasiFisik = data?.RealisasiFisik2 || 0;
  ...
  return (
    ...
    >
      {/* Card 1: APBD Perubahan */}
      <View style={styles.card}>
        <View style={styles.cardHeader}>
          <Icon name="wallet" size={24} color="#0074BD" />
          <Text style={styles.cardHeaderText}>APBD Perubahan</Text>
        </View>
          ...
          <View style={styles.cardContent}>
            ...
            <View style={styles.statsRow}>
              <View style={styles.statItem}>
                ...
                <Text style={styles.statValue}>{data?.JumlahProgram2 || 0}</Text>
              </View>
              <View style={styles.statDivider} />
              <View style={styles.statItem}>
                <Text style={styles.statLabel}>Kegiatan</Text>
                <Text style={styles.statValue}>{data?.JumlahKegiatan2 || 0}</Text>
              </View>
            </View>
          </View>
        </View>
