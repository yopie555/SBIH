...
const GrafikAHH = (props) => {
  ...
  const getProductionCategory = (jumlah) => {
    ...
    if (value >= 7000) return { label: 'Sangat Tinggi', color: '#43a047' };
    if (value >= 5500 && value < 7000) return { label: 'Tinggi', color: '#1e88e5' };
    if (value >= 4500 && value < 5500) return { label: 'Sedang', color: '#fb8c00' };
        ...
        {last5Years.length > 0 && (
          <View style={styles.infoCard}>
            ...
            <View style={styles.infoContent}>
              ...
              <View style={styles.infoRow}>
                <View style={styles.infoDot} />
                <Text style={styles.infoText}>Semakin tinggi nilai, semakin produktif sektor peternakan</Text>
              </View>
            </View>
          </View>
        )}
