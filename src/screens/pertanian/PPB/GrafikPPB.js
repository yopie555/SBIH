...
const GrafikPPB = (props) => {
  ...
  const currentCategory = getPPBCategory(latestValue);
    ...
    <View style={styles.container}>
      ...
      >
        ...
        <View style={styles.periodCard}>
          <Icon name="time-outline" size={24} color="#00796b" />
          ...
          <View style={styles.trendContent}>
            <View style={styles.trendItem}>
              ...
              <Text style={[styles.trendValue, { 
                ...
                {latestValue > values[0] ? '↑' : '↓'} {formatNumber(Math.abs(latestValue - values[0]))} Ton
              </Text>
            </View>
            <Text style={styles.trendDescription}>
              {latestValue > values[0] 
                ? 'Tren meningkat, sektor perikanan budidaya berkembang baik' 
                : 'Tren menurun, perlu peningkatan dukungan dan teknologi'}
            </Text>
          </View>
        </View>
        ...
        <View style={styles.infoCard}>
          ...
          <View style={styles.infoContent}>
            ...
            <View style={styles.infoRow}>
              <View style={styles.infoDot} />
              <Text style={styles.infoText}>Mencakup hasil budidaya tambak, kolam, dan keramba</Text>
            </View>
          </View>
        </View>
