...
const GrafikAHH = (props) => {
  ...
  <LineChart
    data={{
      labels: dataProduksiPerikananBudidaya && dataProduksiPerikananBudidaya.map(item => item.tahun),
      datasets: [
        {
          data: dataProduksiPerikananBudidaya && dataProduksiPerikananBudidaya.map(item => item.jumlah)
        }
      ]
    }}
