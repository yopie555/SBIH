      ...
      >
              ...
              <View style={styles.dataCard}>
                <View style={styles.cardHeader}>
                  <View style={styles.yearBadge}>
                    <Icon name="calendar" size={18} color="#00796b" />
                ...
                <View style={styles.cardBody}>
                  <View style={styles.ppbContainer}>
                    <Icon name={category.icon} size={32} color={category.color} />
                    <View style={styles.ppbContent}>
                      <Text style={[styles.ppbValue, { color: category.color }]}>
                        {formatNumber(item.jumlah)}
                      </Text>
                      <Text style={styles.ppbLabel}>Ton</Text>
                    </View>
                  </View>
                  ...
                  <View style={styles.interpretationBox}>
                    <Icon name="information-circle" size={18} color="#00796b" />
                    <Text style={styles.interpretationText}>
                      {parseFloat(item.jumlah) >= 10000 
                        ? 'Produksi perikanan budidaya sangat tinggi, sektor berkembang baik'
                        : parseFloat(item.jumlah) >= 5000
                        ? 'Produksi perikanan budidaya tinggi, potensi terus berkembang'
                        : 'Perlu peningkatan teknologi dan dukungan sektor perikanan'}
                    </Text>
                  </View>
                </View>
                ...
                <View style={styles.cardFooter}>
                  ...
                  <Text style={styles.footerText}>Produksi Perikanan Budidaya (Ton)</Text>
                </View>
              </View>
            </AnimatedCard>
          )
        ...
        <View style={styles.infoCard}>
          <View style={styles.infoHeader}>
            ...
            <Text style={styles.infoTitle}>Tentang PPB</Text>
          </View>
          <View style={styles.infoContent}>
            <Text style={styles.infoText}>
              Produksi Perikanan Budidaya menunjukkan hasil produksi ikan dari kegiatan 
              budidaya seperti tambak, kolam, keramba, dan jaring apung. Data ini mencerminkan 
              perkembangan sektor perikanan budidaya di daerah.
            </Text>
          </View>
        </View>
      </ScrollView>
