...
const GrafikPPT = (props) => {
  ...
  const currentCategory = getPPTCategory(latestValue);
    ...
    <View style={styles.container}>
      ...
      <View style={styles.header}>
        <View style={styles.headerTop}>
          <Icon name="analytics" size={32} color="#01579b" />
      ...
      >
        ...
        <View style={styles.periodCard}>
          <Icon name="time-outline" size={24} color="#01579b" />
        ...
        <View style={styles.chartCard}>
          <View style={styles.chartHeader}>
            <Icon name="bar-chart" size={24} color="#01579b" />
        ...
        <View style={styles.infoCard}>
          ...
          <View style={styles.infoContent}>
            ...
            <View style={styles.infoRow}>
              <View style={styles.infoDot} />
              <Text style={styles.infoText}>Hasil tangkapan ikan dari perairan laut</Text>
            </View>
          </View>
        </View>
