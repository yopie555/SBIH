...
const GrafikAHH = (props) => {
  ...
  <LineChart
    data={{
      labels: dataProduksiPerikananTangkap && dataProduksiPerikananTangkap.map(item => item.tahun),
      datasets: [
        {
          data: dataProduksiPerikananTangkap && dataProduksiPerikananTangkap.map(item => item.jumlah)
        }
      ]
    }}
