...
const GrafikCPKUP = (props) => {
  ...
  const last5Years = dataCapaianProduksiKomoditiUnggulanPerkebunan.slice(-5);
  ...
  const currentCategory = getCPKUPCategory(latestValue);
    ...
    <View style={styles.container}>
      ...
      <View style={styles.header}>
        <View style={styles.headerTop}>
          <Icon name="analytics" size={32} color="#558b2f" />
      ...
      >
        ...
        <View style={styles.periodCard}>
          <Icon name="time-outline" size={24} color="#558b2f" />
        ...
        <View style={styles.chartCard}>
          <View style={styles.chartHeader}>
            <Icon name="bar-chart" size={24} color="#558b2f" />
          ...
          <View style={styles.chartWrapper}>
            <LineChart
              ...
              chartConfig={{
                ...
                backgroundGradientFrom: "#558b2f",
                backgroundGradientTo: "#689f38",
                decimalPlaces: 0,
        ...
        <View style={styles.infoCard}>
          ...
          <View style={styles.infoContent}>
            ...
            <View style={styles.infoRow}>
              <View style={styles.infoDot} />
              <Text style={styles.infoText}>Komoditi unggulan: kelapa sawit, karet, kakao, dll</Text>
            </View>
          </View>
        </View>
