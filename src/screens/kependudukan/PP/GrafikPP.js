...
const GrafikPP = (props) => {
  ...
  const last5Years = dataPertumbuhanPenduduk?.slice(-5) || [];
  ...
  const getGrowthCategory = (laju) => {
    ...
    if (value >= 3.0) return { label: 'Sangat Tinggi', color: '#e53935' };
    if (value >= 2.0 && value < 3.0) return { label: 'Tinggi', color: '#fb8c00' };
    if (value >= 1.0 && value < 2.0) return { label: 'Sedang', color: '#1e88e5' };
    if (value >= 0 && value < 1.0) return { label: 'Rendah', color: '#43a047' };
    return { label: 'Negatif', color: '#757575' };
  };

  const currentCategory = getGrowthCategory(latestValue);
      ...
      >
            ...
            <View style={styles.currentValueContainer}>
              ...
              <View style={styles.currentValueWrapper}>
                <Text style={styles.currentValueText}>
                  Laju Pertumbuhan Terkini: <Text style={[styles.currentValue, { color: currentCategory.color }]}>{formatPercentage(latestValue)}%</Text>
                </Text>
            ...
            <View style={styles.trendContent}>
              <View style={styles.trendItem}>
                ...
                <Text style={[styles.trendValue, { 
                  color: latestValue > values[0] ? '#e53935' : '#43a047' 
                }]}>
              ...
              <Text style={styles.trendDescription}>
                {latestValue > values[0] 
                  ? 'Tren meningkat, pertumbuhan penduduk naik - perlu perluasan infrastruktur' 
                  : 'Tren menurun, pertumbuhan penduduk melambat - lebih terkendali'}
              </Text>
            </View>
          </View>
        )}
        ...
        {last5Years.length > 0 && (
          <View style={styles.infoCard}>
            ...
            <View style={styles.infoContent}>
              ...
              <View style={styles.infoRow}>
                <View style={styles.infoDot} />
                <Text style={styles.infoText}>Laju pertumbuhan dalam persen per tahun</Text>
              </View>
              <View style={styles.infoRow}>
                <View style={styles.infoDot} />
              ...
              <View style={styles.infoRow}>
                <View style={styles.infoDot} />
                <Text style={styles.infoText}>Nilai positif: pertumbuhan, negatif: penurunan penduduk</Text>
              </View>
            </View>
          </View>
        )}
        ...
        <View style={styles.contextCard}>
          <View style={styles.contextHeader}>
            <Icon name="bulb" size={24} color="#fb8c00" />
            <Text style={styles.contextTitle}>Interpretasi</Text>
          </View>
          <View style={styles.contextContent}>
            <Text style={styles.contextText}>
              <Text style={styles.contextBold}>Pertumbuhan Tinggi:</Text> Memerlukan perencanaan pembangunan infrastruktur, layanan kesehatan, dan pendidikan yang lebih intensif.
            </Text>
            <Text style={styles.contextText}>
              <Text style={styles.contextBold}>Pertumbuhan Rendah:</Text> Lebih mudah dikelola, pembangunan dapat difokuskan pada peningkatan kualitas hidup.
            </Text>
          </View>
        </View>
