...
const GrafikAPK = (props) => {
  ...
  const values = last5Years.map(item => parseFloat(item.apk));
    ...
    <View style={styles.container}>
      ...
      <View style={styles.header}>
        <View style={styles.headerTop}>
          <Icon name="analytics" size={32} color="#5e35b1" />
      ...
      >
        ...
        <View style={styles.chartCard}>
          <View style={styles.chartHeader}>
            ...
            <Text style={styles.chartTitle}>Tren APK {selectedLevel} (5 Tahun)</Text>
          </View>
          ...
          <View style={styles.currentValueContainer}>
            ...
            <View style={styles.currentValueWrapper}>
              <Text style={styles.currentValueText}>
                APK {selectedLevel} Terkini: <Text style={[styles.currentValue, { color: getLevelColor(selectedLevel) }]}>{latestValue}%</Text>
              </Text>
            </View>
          </View>
        </View>
        ...
        <View style={styles.infoCard}>
          ...
          <View style={styles.infoContent}>
            ...
            <View style={styles.infoRow}>
              <View style={styles.infoDot} />
              <Text style={styles.infoText}>APK {">"} 100% menunjukkan siswa di luar usia standar</Text>
            </View>
            <View style={styles.infoRow}>
              <View style={styles.infoDot} />
            ...
            <View style={styles.infoRow}>
              <View style={styles.infoDot} />
              <Text style={styles.infoText}>Pilih jenjang pendidikan menggunakan filter di atas</Text>
            </View>
          </View>
        </View>
      </ScrollView>
