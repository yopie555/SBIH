...
const DetailPS = (props) => {
  ...
  const getStuntingCategory = (ps) => {
    ...
    if (value >= 20 && value < 30) return { label: 'Sedang', color: '#fb8c00', icon: 'warning' };
      ...
      >
              ...
              <View style={styles.dataCard}>
                <View style={styles.cardHeader}>
                  <View style={styles.yearBadge}>
                    <Icon name="calendar" size={18} color="#fb8c00" />
                ...
                <View style={styles.cardFooter}>
                  ...
                  <Text style={styles.footerText}>Persentase Balita Stunting</Text>
                </View>
              </View>
            </AnimatedCard>
          )
        ...
        {dataPS?.length === 0 && (
          <View style={styles.emptyState}>
            <Icon name="fitness-outline" size={80} color="#ccc" />
