...
const GrafikPS = (props) => {
  ...
  const getStuntingCategory = (ps) => {
    ...
    if (value >= 10 && value < 20) return { label: 'Rendah', color: '#1e88e5' };
    if (value >= 20 && value < 30) return { label: 'Sedang', color: '#fb8c00' };
    ...
    <View style={styles.container}>
      ...
      >
        ...
        <View style={styles.periodCard}>
          <Icon name="time-outline" size={24} color="#fb8c00" />
        ...
        <View style={styles.chartCard}>
          <View style={styles.chartHeader}>
            <Icon name="bar-chart" size={24} color="#fb8c00" />
        ...
        <View style={styles.infoCard}>
          <View style={styles.infoHeader}>
            <Icon name="information-circle" size={24} color="#fb8c00" />
          ...
          <View style={styles.infoContent}>
            ...
            <View style={styles.infoRow}>
              <View style={styles.infoDot} />
              <Text style={styles.infoText}>Prevalensi stunting pada balita di bawah 5 tahun</Text>
            </View>
            <View style={styles.infoRow}>
              <View style={styles.infoDot} />
        ...
        <View style={styles.legendCard}>
          <Text style={styles.legendTitle}>Kategori Prevalensi Stunting:</Text>
          <View style={styles.legendContent}>
            <View style={styles.legendItem}>
              <View style={[styles.legendDot, { backgroundColor: '#43a047' }]} />
              <Text style={styles.legendText}>Sangat Rendah {`(<10%)`}</Text>
            </View>
            <View style={styles.legendItem}>
              <View style={[styles.legendDot, { backgroundColor: '#1e88e5' }]} />
              <Text style={styles.legendText}>Rendah (10-19.99%)</Text>
            </View>
            <View style={styles.legendItem}>
              <View style={[styles.legendDot, { backgroundColor: '#fb8c00' }]} />
              <Text style={styles.legendText}>Sedang (20-29.99%)</Text>
            </View>
            <View style={styles.legendItem}>
              <View style={[styles.legendDot, { backgroundColor: '#e53935' }]} />
              <Text style={styles.legendText}>Tinggi (≥30%)</Text>
            </View>
          </View>
        </View>
      </ScrollView>
