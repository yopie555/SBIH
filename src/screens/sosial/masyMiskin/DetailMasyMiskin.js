...
const DetailMasyMiskin = (props) => {
  ...
  const getKemiskinanCategory = (persentase) => {
    ...
    if (value >= 10 && value < 15) return { label: 'Sedang', color: '#fb8c00', icon: 'remove' };
    return { label: 'Tinggi', color: '#e53935', icon: 'sad' };
  };
              ...
              <View style={styles.dataCard}>
                <View style={styles.cardHeader}>
                  <View style={styles.yearBadge}>
                    <Icon name="calendar" size={18} color="#e53935" />
                ...
                <View style={styles.cardBody}>
                  <View style={styles.percentageContainer}>
                    <Icon name="people" size={24} color={category.color} />
                    <View>
                      <Text style={[styles.percentageValue, { color: category.color }]}>
                        {item.presentase}%
                      </Text>
                      <Text style={styles.percentageLabel}>Tingkat Kemiskinan</Text>
                    </View>
                  </View>
                ...
                <View style={styles.cardFooter}>
                  ...
                  <Text style={styles.footerText}>Persentase Penduduk Miskin</Text>
                </View>
              </View>
            </AnimatedCard>
          )
