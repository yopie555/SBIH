...
const GrafikMasyMiskin = (props) => {
  ...
  const last5Years = dataPenduduk.slice(-5);
  ...
  const getKemiskinanCategory = (persentase) => {
    ...
    if (value < 5) return { label: 'Sangat Rendah', color: '#43a047' };
    if (value >= 5 && value < 10) return { label: 'Rendah', color: '#1e88e5' };
    if (value >= 10 && value < 15) return { label: 'Sedang', color: '#fb8c00' };
    ...
    <View style={styles.container}>
      ...
      >
        ...
        <View style={styles.periodCard}>
          <Icon name="time-outline" size={24} color="#e53935" />
        ...
        <View style={styles.chartCard}>
          <View style={styles.chartHeader}>
            <Icon name="bar-chart" size={24} color="#e53935" />
        ...
        <View style={styles.infoCard}>
          <View style={styles.infoHeader}>
            <Icon name="information-circle" size={24} color="#e53935" />
          ...
          <View style={styles.infoContent}>
            ...
            <View style={styles.infoRow}>
              <View style={styles.infoDot} />
              <Text style={styles.infoText}>Persentase penduduk yang berada di bawah garis kemiskinan</Text>
            </View>
            <View style={styles.infoRow}>
              <View style={styles.infoDot} />
        ...
        <View style={styles.legendCard}>
          <Text style={styles.legendTitle}>Kategori Tingkat Kemiskinan:</Text>
          <View style={styles.legendContent}>
            <View style={styles.legendItem}>
              <View style={[styles.legendDot, { backgroundColor: '#43a047' }]} />
              <Text style={styles.legendText}>Sangat Rendah {`(<5%)`}</Text>
            </View>
            <View style={styles.legendItem}>
              <View style={[styles.legendDot, { backgroundColor: '#1e88e5' }]} />
              <Text style={styles.legendText}>Rendah (5-9.99%)</Text>
            </View>
            <View style={styles.legendItem}>
              <View style={[styles.legendDot, { backgroundColor: '#fb8c00' }]} />
              <Text style={styles.legendText}>Sedang (10-14.99%)</Text>
            </View>
            <View style={styles.legendItem}>
              <View style={[styles.legendDot, { backgroundColor: '#e53935' }]} />
              <Text style={styles.legendText}>Tinggi (≥15%)</Text>
            </View>
          </View>
        </View>
      </ScrollView>
