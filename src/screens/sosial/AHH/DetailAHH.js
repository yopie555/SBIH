...
const DetailAHH = (props) => {
  ...
  const getAHHCategory = (ahh) => {
    ...
    if (value >= 65 && value < 70) return { label: 'Sedang', color: '#fb8c00', icon: 'pulse' };
      ...
      >
              ...
              <View style={styles.dataCard}>
                <View style={styles.cardHeader}>
                  <View style={styles.yearBadge}>
                    <Icon name="calendar" size={18} color="#d32f2f" />
                ...
                <View style={styles.cardBody}>
                  <View style={styles.ahhContainer}>
                    ...
                    <View style={styles.ahhContent}>
                      ...
                      <Text style={styles.ahhLabel}>Tahun</Text>
                    </View>
                  </View>
                  ...
                  <View style={styles.interpretationBox}>
                    <Icon name="information-circle" size={18} color="#d32f2f" />
                    <Text style={styles.interpretationText}>
                      Penduduk diharapkan hidup hingga usia {item.ahh} tahun
                    </Text>
                  </View>
                </View>
                ...
                <View style={styles.cardFooter}>
                  ...
                  <Text style={styles.footerText}>Angka Harapan Hidup Saat Lahir</Text>
                </View>
              </View>
            </AnimatedCard>
          )
        ...
        <View style={styles.infoCard}>
          <View style={styles.infoHeader}>
            ...
            <Text style={styles.infoTitle}>Tentang AHH</Text>
          </View>
          <View style={styles.infoContent}>
            <Text style={styles.infoText}>
              ...
              AHH menggambarkan derajat kesehatan suatu masyarakat.
            </Text>
          </View>
        </View>
      </ScrollView>
