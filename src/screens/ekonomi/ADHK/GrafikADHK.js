        ...
        <View style={styles.container}>  
            <View style={styles.header}>
                <View style={styles.headerTop}>
                    <Icon name="analytics" size={32} color="#0288d1" />
            ...
            {graphData ? (
                ...
                >
                    ...
                    <View style={styles.periodCard}>
                        <Icon name="time-outline" size={24} color="#0288d1" />
                    ...
                    <View style={styles.chartCard}>
                        <View style={styles.chartHeader}>
                            <Icon name="bar-chart" size={24} color="#0288d1" />
                        ...
                        <View style={styles.currentValueContainer}>
                            ...
                            <View style={styles.currentValueWrapper}>
                                <Text style={styles.currentValueText}>
                                    ADHK Terkini: <Text style={styles.currentValue}>{formatRupiah(graphData.latestValue)}</Text>
                                </Text>
                            </View>
                        </View>
                    </View>
                    ...
                    <View style={styles.trendCard}>
                        <View style={styles.trendHeader}>
                            <Icon name="analytics-outline" size={24} color="#0288d1" />
                        ...
                        <View style={styles.trendContent}>
                            ...
                            <Text style={styles.trendDescription}>
                                {graphData.latestValue > graphData.values[0] 
                                    ? 'Tren meningkat, pertumbuhan ekonomi riil positif' 
                                    : 'Tren menurun, perlu evaluasi pertumbuhan ekonomi'}
                            </Text>
                        </View>
                    </View>
                    ...
                    <View style={styles.infoCard}>
                        ...
                        <View style={styles.infoContent}>
                            ...
                            <View style={styles.infoRow}>
                                <View style={styles.infoDot} />
                                <Text style={styles.infoText}>ADHK = Atas Dasar Harga Konstan</Text>
                            </View>
                            <View style={styles.infoRow}>
                                <View style={styles.infoDot} />
