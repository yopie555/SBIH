...
const DetailKW = (props) => {
  ...
  const getKWCategory = (jumlah) => {
    ...
    if (value >= 10000 && value < 50000) return { label: 'Sedang', color: '#fb8c00', icon: 'remove' };
      ...
      >
            ...
            <AnimatedCard key={`${item.tahun}-${index}`} delay={index * 50}>
              <View style={styles.dataCard}>
                ...
                <View style={styles.cardFooter}>
                  ...
                  <Text style={styles.footerText}>Jumlah Kunjungan Wisata (Orang)</Text>
                </View>
              </View>
            </AnimatedCard>
          )
        ...
        <View style={styles.infoCard}>
          <View style={styles.infoHeader}>
            ...
            <Text style={styles.infoTitle}>Tentang Kunjungan Wisata</Text>
          </View>
          <View style={styles.infoContent}>
            <Text style={styles.infoText}>
              Jumlah Kunjungan Wisata menunjukkan banyaknya wisatawan yang berkunjung 
              ke destinasi wisata dalam periode tertentu. Data ini mencerminkan daya tarik 
              wisata dan kontribusi sektor pariwisata terhadap ekonomi daerah.
            </Text>
          </View>
        </View>
      </ScrollView>
